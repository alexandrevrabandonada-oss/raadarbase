...
export function OperationalCommandBar({
  ...
  return (
    <section
      aria-label={title}
      className={cn(
        "fixed inset-x-0 bottom-0 z-40 px-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] lg:sticky lg:top-4 lg:z-30 lg:px-0 lg:pb-0",
        className,
      )}
    >
      <div className="mx-auto max-w-7xl">
        <div className="radar-outline-card rounded-[24px] border border-[#d8c7ac] bg-[rgba(255,250,242,0.96)] p-3 shadow-[0_18px_48px_rgba(15,23,42,0.14)] backdrop-blur-md lg:p-4">
